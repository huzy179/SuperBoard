...
- Config files: jest.config._, vitest.config._, pytest.ini, .mocharc.\*, etc.
- Test directories: **tests**/, tests/, spec/, test/
- Test file patterns: _.test._, _.spec._, test\__.py, _\_test.go
