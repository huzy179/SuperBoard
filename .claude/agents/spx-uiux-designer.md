...
| next.config._ | nextjs |
| nuxt.config._ or vue in package.json | vue |
| svelte.config._ | svelte |
| tailwind.config._ | html-tailwind (or combined) |
...
- Theme files: Glob for _theme_, _tokens_, _design-system_
- Component library: Check package.json for shadcn, @mui, antd, chakra-ui, etc.

Existing UI Patterns:

- Layout files (_layout_, _template_)
