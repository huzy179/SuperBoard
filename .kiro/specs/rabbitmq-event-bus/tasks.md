...
- [-] 1. Contract Package — RabbitMQ Event Schema (`@superboard/shared`)
  ...
  - [ ] 1.1 Write property test for routing key format (P15)
  ...
  - [ ] 1.2 Write property test for queue naming convention (P5)
...
- [ ] 2. Infrastructure — RabbitMQ Docker Compose
...
- [ ] 3. Core API — RabbitMQ Event Bus Service
  - [ ] 3.1 Cài đặt dependency `amqplib` và `@types/amqplib` vào `apps/api`
    - Thêm vào `package.json` của `apps/api`
    - _Requirements: 3.1_

  - [ ] 3.2 Implement `RabbitMQEventBusService`
  ...
  - [ ] 3.3 Write property test for routing key equals event type (P1)
  ...
  - [ ] 3.4 Write property test for persistent AMQP properties (P2)
  ...
  - [ ] 3.5 Write property test for exponential backoff (P3)
  ...
  - [ ] 3.6 Write property test for no unhandled exception on exhaustion (P4)
...
- [ ] 4. Core API — EventBusModule và Feature Flag
  - [ ] 4.1 Cập nhật `EventBusModule`
  ...
  - [ ] 4.2 Write property test for feature flag routing (P11)
  ...
  - [ ] 4.3 Write property test for BullMQ notification queue independence (P12)
...
- [ ] 5. Core API — Topology Declaration cho Consumer Queues
  - [ ] 5.1 Implement topology helper cho tất cả consumer queues
  ...
  - [ ] 5.2 Write property test for DLX in all queue args (P6)
  ...
  - [ ] 5.3 Write property test for idempotent topology (P7)
...
- [ ] 6. Core API — Health Check và Observability
  - [ ] 6.1 Implement `RabbitMQHealthIndicator`
  ...
  - [ ] 6.3 Write property test for publish metrics (P13)
  ...
  - [ ] 6.4 Cập nhật `.env.example` của Core API
