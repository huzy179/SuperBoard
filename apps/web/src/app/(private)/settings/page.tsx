  ...
  return (
    <section className="animate-fade-in pb-12">
      <div className="mb-6 flex items-center justify-between">
        ...
        {activeTab === 'workspace' && canChangeRoles && (
          <button
            type="button"
      ...
      {activeTab === 'profile' ? (
        <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <section className="space-y-6 rounded-xl border border-surface-border bg-surface-card p-6 shadow-sm">
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            {m.userId !== user?.id && m.role !== 'owner' && (
                              <button
                                ...
                                onClick={() => {
                                  if (
                                    confirm(`Bạn có chắc muốn xóa ${m.fullName} khỏi workspace?`)
                                  ) {
              ...
              {filteredMembers.length === 0 ? (
                <div className="border-t border-surface-border px-4 py-8 text-center">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Hãy thử đổi từ khoá hoặc bộ lọc vai trò
                  </p>
                </div>
              ) : null}
            </div>
