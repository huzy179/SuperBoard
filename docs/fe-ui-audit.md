# FE UI Audit (2026-04-28)

Targets: `apps/web/src`, `packages/ui/src`

## Totals

- Terminal/dark text: **1114**
- Terminal/dark backgrounds: **116**
- White borders: **512**
- Glow shadows: **196**
- Attention animations: **166**
- Aggressive uppercase UI: **774**
- Dense tracking (terminal style): **267**
- Backdrop blur: **116**
...
| ----------------------------------------------------------------------------------- | ----: | --------------------------------------------------------------------------------------------------------- |
| `apps/web/src/features/operations/task/components/task-edit-slide-over.tsx`         |   152 | dark_text:44, dark_bg:5, white_borders:18, glow:2, pulse:12, upper:40, tracking_dense:25, backdrop_blur:6 |
...
| `apps/web/src/features/operations/project/components/MissionCommandBriefing.tsx`    |    98 | dark_text:33, dark_bg:4, white_borders:7, glow:12, pulse:4, upper:23, tracking_dense:12, backdrop_blur:3  |
| `apps/web/src/features/operations/project/components/project-detail-header.tsx`     |    86 | dark_text:30, dark_bg:2, white_borders:10, glow:11, pulse:4, upper:16, tracking_dense:10, backdrop_blur:3 |
...
| `apps/web/src/features/operations/project/components/StrategicSandbox.tsx`          |    51 | dark_text:19, dark_bg:1, white_borders:8, glow:1, pulse:2, upper:10, tracking_dense:9, backdrop_blur:1    |
...
| `apps/web/src/features/operations/project/components/project-card.tsx`              |    50 | dark_text:23, dark_bg:2, white_borders:7, glow:3, upper:12, tracking_dense:2, backdrop_blur:1             |
...
| `apps/web/src/features/intelligence/ai/components/neural-workspace-digest.tsx`      |    38 | dark_text:10, dark_bg:1, white_borders:7, glow:1, pulse:2, upper:9, tracking_dense:6, backdrop_blur:2     |
